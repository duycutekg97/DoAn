...
const Footer = () => {
  return (
    <div
  class="flex flex-col items-center bg-cyan-700 text-center text-white dark:bg-cyan-700 dark:text-neutral-200">
  ...
  MotelHelpness
  <div
    class="w-full bg-cyan-700 p-4 text-center text-neutral-200 dark:bg-cyan-700 dark:text-neutral-200">
    © 2023 Đại Học Mở Thành Phố Hồ Chí Minh
    <div class="dark:text-neutral-200" href="https://tailwind-elements.com/"
      >Khoa Học Máy Tính</div
    >
  </div>
</div>
